    ...
    <main className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-900 via-cyan-900 to-black text-white p-4 antialiased relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto pt-16 flex flex-col items-center px-4 relative z-10">
        ...
        <div className="w-full max-w-md space-y-3">
          {/* Liens sociaux - Exemple pour YouTube, répétez pour chaque lien */}
          ...
          {/* Répétez le même pattern pour les autres liens en gardant la même structure mais en changeant juste l'icône et le texte */}
