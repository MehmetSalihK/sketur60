          ...
          <div className="w-full max-w-md space-y-3">
            ...
            <Link href="https://www.kick.com/sketur60" 
              ...
              <div className="flex items-center space-x-2">
                ...
                <svg className="w-6 h-6 text-[#53fc18]" fill="currentColor" viewBox="0 0 512 512"><path d="M37 .036h164.448v113.621h54.71v-56.82h54.731V.036h164.448v170.777h-54.73v56.82h-54.711v56.8h54.71v56.82h54.73V512.03H310.89v-56.82h-54.73v-56.8h-54.711v113.62H37V.036z"/></svg>
              </div>
            </Link>
